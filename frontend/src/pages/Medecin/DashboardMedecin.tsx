...
export default function DashboardMedecin() {
  ...
  const saveDraftConsultation = async () => {
    ...
    await saveClinicalSections(currentConsultationId, {
      ...
      medicalHistory: {
        ...
        currentMedications: consultationModule.currentMedications.map((item) => ({ drugName: item.drugName, dosage: item.dosage, compliance: item.compliance })).filter((item) => item.drugName || item.dosage),
      ...
      treatmentPlan: {
        ...
        safetyConsignes: consultationModule.safetyConsignes,
        sickLeave: consultationModule.sickLeave,
        followUp: consultationModule.followUp,
      },
      followUp: {
        ...
        recommendedInterval: consultationModule.followUp.recommendedInterval,
        specificDate: consultationModule.followUp.specificDate,
      },
  ...
  const validateConsultation = async () => {
    ...
    await saveClinicalSections(currentConsultationId, {
      ...
      treatmentPlan: {
        notes: clinicalForm.treatmentPlan,
        description: consignesDescription,
        safetyConsignes: consultationModule.safetyConsignes,
        sickLeave: consultationModule.sickLeave,
        followUp: consultationModule.followUp,
