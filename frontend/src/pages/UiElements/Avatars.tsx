...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Aulia Care - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Aulia Care - React.js Tailwind CSS Admin Dashboard Template"
      />
