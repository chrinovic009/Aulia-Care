...
export type DoctorPatient = {
  ...
  labRequests?: Array<{ id: string; status: string; requestedAt: string; specimenType?: string | null; notes?: string | null; results?: Array<{ resultName: string; resultValue: string; units?: string | null; referenceRange?: string | null; verified?: boolean; interpretation?: string | null; parameters?: Array<{ id?: string; labTestParameter?: { name?: string | null; unit?: string | null; referenceRange?: string | null }; valueNumeric?: number | string | null; valueText?: string | null; interpretation?: string | null }> }> }>;
